...
async function imageToWebp (media) {
    ...
    const tmpFileOut = path.join(__dirname, "..", "..", "tmp", `${new Date * 1}.webp`)
    const tmpFileIn = path.join(__dirname, "..", "..", "tmp", `${new Date * 1}.jpg`)
...
async function videoToWebp (media) {
    ...
    const tmpFileOut = path.join(__dirname, "..", "..", "tmp", `${new Date * 1}.webp`)
    const tmpFileIn = path.join(__dirname, "..", "..", "tmp", `${new Date * 1}.mp4`)
...
async function writeExifImg (media, metadata) {
    ...
    const tmpFileOut = path.join(__dirname, "..", "..", "tmp", `${new Date * 1}.webp`)
    const tmpFileIn = path.join(__dirname, "..", "..", "tmp", `${new Date * 1}.webp`)
